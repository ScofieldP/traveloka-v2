        ...
        <div className="popular_food">
          <div className="container w-75">
            <div className="row  border border-dark">
              <div className="col-6">
                <p className="fs-4">Popular Cuisines</p>
                <div class="row row-cols-2 row-cols-lg-3 g-2 g-lg-3">
                <div class="col">
                  <img src="/assets/img/food-3.png" alt="logo" />
                </div>
                <div class="col">
              ...
              <div className="col-6">
                <p className="fs-4">Popular Dishes</p>
                <div class="row row-cols-2 row-cols-lg-3 g-2 g-lg-3">
                <div class="col">
                <img src="/assets/img/food-9.png" alt="logo" />
                </div>
                <div class="col">
                <img src="/assets/img/food-10.png" alt="logo" />
                </div>
                <div class="col">
                <img src="/assets/img/food-11.png" alt="logo" />
                </div>
                <div class="col">
                <img src="/assets/img/food-12.png" alt="logo" />
                </div>
                <div class="col">
                <img src="/assets/img/food-13.png" alt="logo" />
                </div>
                <div class="col">
